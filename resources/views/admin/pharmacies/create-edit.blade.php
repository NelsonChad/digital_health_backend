        ...
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-center">
                    <img style="width: 120px; height: 120px;" class="img-profile rounded-circle" class="card-img-top" src="{{ asset('uploads/pharmacies/' . $pharmacy->logo) }}" alt="logo">
                </div>
                <br>
                @endisset
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.pharmacies.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $pharmacy->name ?? old('name') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="address" type="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ $pharmacy->address ?? old('address') }}" required autocomplete="Endereço">
                                    @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" name="logo" class="form-control" id="inputLogo" placeholder="Insira uma imagem">
                                    @error('logo')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="open_time" type="time" class="form-control @error('open_time') is-invalid @enderror" name="open_time" value="{{ $pharmacy->open_time ?? old('open_time') }}" required autocomplete="open time" autofocus>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="cloese_time" type="time" class="form-control @error('cloese_time') is-invalid @enderror" name="close_time" value="{{ $pharmacy->cloese_time ?? old('cloese_time') }}" required autocomplete="open time" autofocus>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="latitude" type="text" class="form-control @error('latitude') is-invalid @enderror" name="latitude" value="{{ $pharmacy->latitude ?? old('latitude') }}" required autocomplete="latitude" autofocus>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="longitude" type="text" class="form-control @error('longitude') is-invalid @enderror" name="longitude" value="{{ $pharmacy->longitude ?? old('longitude') }}" required autocomplete="longitude" autofocus>
